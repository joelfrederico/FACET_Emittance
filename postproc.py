...
\midrule
Pinch Energy [GeV] & {:0.3f} \\
Normalized Emittance [mm-mrad] &  {:0.3f} \\
Beta* [m] &  {:0.3f} \\
S* [m] & {:0.3f} \\
\bottomrule
'''
            ...
            # Add values to table_mid
            table_begin = table_begin.format(setdate,uid,quadval,pinch_energy,emit_n*1e6,betastar,sstar)
        
            tablestr=table_begin
